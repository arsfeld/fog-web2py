...
//          fisheyemenu.imgSmall(y);
    ...
    imgSmall : function (obj) {
        ...
        var sizePos = imgSrc.indexOf('large', 0);
        var pathName = imgSrc.substr(0, sizePos);
        var imgName = imgSrc.substr(sizePos + 5)
        obj.setAttribute("src", pathName + 'small' + imgName);
    },
    imgLarge : function (obj) {
        imgSrc = obj.getAttribute("src");
        var sizePos = imgSrc.indexOf('small', 0);
        var pathName = imgSrc.substr(0, sizePos);
        var imgName = imgSrc.substr(sizePos + 5)
        obj.setAttribute("src", pathName + 'large' + imgName);
    }
}
